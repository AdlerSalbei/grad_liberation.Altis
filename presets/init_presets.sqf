...
militia_squad = [militia_squad, {[_x] call grad_liberation_shared_fnc_checkClass}] call BIS_fnc_conditionalSelect;
militia_vehicles = [militia_vehicles, {[_x] call grad_liberation_shared_fnc_checkClass}] call BIS_fnc_conditionalSelect;
opfor_vehicles = [opfor_vehicles, {[_x] call grad_liberation_shared_fnc_checkClass}] call BIS_fnc_conditionalSelect;
opfor_vehicles_low_intensity = [opfor_vehicles_low_intensity, {[_x] call grad_liberation_shared_fnc_checkClass}] call BIS_fnc_conditionalSelect;
opfor_battlegroup_vehicles = [opfor_battlegroup_vehicles, {[_x] call grad_liberation_shared_fnc_checkClass}] call BIS_fnc_conditionalSelect;
opfor_battlegroup_vehicles_low_intensity = [opfor_battlegroup_vehicles_low_intensity, {[_x] call grad_liberation_shared_fnc_checkClass}] call BIS_fnc_conditionalSelect;
opfor_troup_transports = [opfor_troup_transports, {[_x] call grad_liberation_shared_fnc_checkClass}] call BIS_fnc_conditionalSelect;
opfor_choppers = [opfor_choppers, {[_x] call grad_liberation_shared_fnc_checkClass}] call BIS_fnc_conditionalSelect;
opfor_air = [opfor_air, {[_x] call grad_liberation_shared_fnc_checkClass}] call BIS_fnc_conditionalSelect;
civilians = [civilians, {[_x] call grad_liberation_shared_fnc_checkClass}] call BIS_fnc_conditionalSelect;
civilian_vehicles = [civilian_vehicles, {[_x] call grad_liberation_shared_fnc_checkClass}] call BIS_fnc_conditionalSelect;
...
KP_liberation_friendly_air_classnames = KP_liberation_friendly_air_classnames select {!(_x call grad_liberation_shared_fnc_isClassUAV)};
