...
switch (_notif_id) do {
	case 0: {
		["lib_civ_informant_start", [markertext ([10000, _pos] call grad_liberation_common_fnc_getNearestSector)]] call BIS_fnc_showNotification;
	...
	case 4: {
		["lib_civ_hvt_start", [markertext ([10000, _pos] call grad_liberation_common_fnc_getNearestSector)]] call BIS_fnc_showNotification;
		private _marker = createMarker ["HVT_marker", _pos];
		_marker setMarkerColor LIB_color_enemy_bright;
		_marker setMarkerType "hd_unknown";

		private _marker_zone = createMarker ["HVT_zone", _pos];
		_marker_zone setMarkerColor LIB_color_enemy_bright;
