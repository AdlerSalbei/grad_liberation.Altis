...
while { liberation_csat_aggressivity > 0.9 && LIB_endgame == 0 } do {
	...
	if ( (count allPlayers >= (10 / liberation_csat_aggressivity) ) && ([] call grad_liberation_shared_fnc_opforCap < LIB_battlegroup_cap) && (combat_readiness >= 70) && (diag_fps > 15.0))  then {
