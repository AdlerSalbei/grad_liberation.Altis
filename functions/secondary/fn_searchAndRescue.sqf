...
private _helowreck = LIB_sar_wreck createVehicle _helopos;
...
private _helofire = LIB_sar_fire createVehicle (getpos _helowreck);
...
private _grppatrol = createGroup LIB_side_enemy;
...
private _grpsentry = createGroup LIB_side_enemy;
...
sleep 1;
LIB_secondary_in_progress = 2; publicVariable "LIB_secondary_in_progress";
