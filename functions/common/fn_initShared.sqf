[] call grad_liberation_common_fnc_killManager =grad_liberation_common_fnc_[] call grad_liberation_common_fnc_killManager.sqf";
...
[] spawngrad_liberation_common_fnc_scan_skill.sqf";
[] spawngrad_liberation_common_fnc_diagnostics.sqf";
if (!liberation_ace) then {[] spawngrad_liberation_common_fnc_manage_weather.sqf";};
