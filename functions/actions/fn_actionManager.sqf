...
while {true} do {
	...
	if (_fobdistance < _distfob && alive player && vehicle player == player && (([ player, 3] call grad_liberation_shared_fnc_fetchPermission) || (player == ([] call grad_liberation_shared_fnc_getCommander) || [] call grad_liberation_shared_fnc_isAdmin))) then {
	...
	if ((count _nearfobbox != 0) && (alive player) && (vehicle player == player) && !(surfaceIsWater getpos player) && ((player distance startbase) > 1000) && (([player, 3] call grad_liberation_shared_fnc_fetchPermission) || (player == ([] call grad_liberation_shared_fnc_getCommander) || [] call grad_liberation_shared_fnc_isAdmin)) && !FOB_build_in_progress) then {
	...
	if (_fobdistance < _distredeploy && alive player && vehicle player == player && (player == ([] call grad_liberation_shared_fnc_getCommander) || [] call grad_liberation_shared_fnc_isAdmin)) then {
	...
	if ((count _prod_sector) == 12) then {
		if (alive player && vehicle player == player && ([player, 3] call grad_liberation_shared_fnc_fetchPermission) && ((count (_prod_sector select 3)) == 0)) then {
		...
		if (alive player && vehicle player == player && ([player, 3] call grad_liberation_shared_fnc_fetchPermission) && ((count (_prod_sector select 3)) == 3) && !(_prod_sector select 4)) then {
		...
		if (alive player && vehicle player == player && ([player, 3] call grad_liberation_shared_fnc_fetchPermission) && ((count (_prod_sector select 3)) == 3) && !(_prod_sector select 5)) then {
		...
		if (alive player && vehicle player == player && ([player, 3] call grad_liberation_shared_fnc_fetchPermission) && ((count (_prod_sector select 3)) == 3) && !(_prod_sector select 6)) then {
	...
	if (((_fobdistance < _distfob) || ((count _prod_sector) == 12)) && (player == ([] call grad_liberation_shared_fnc_getCommander) || [] call grad_liberation_shared_fnc_isAdmin) && alive player && vehicle player == player && ((count KP_liberation_production) > 0)) then {
	...
	if ((player == ([] call grad_liberation_shared_fnc_getCommander) || [] call grad_liberation_shared_fnc_isAdmin) && alive player && vehicle player == player && liberation_permissions_param) then {
