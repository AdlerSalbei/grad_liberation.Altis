/*
grad_liberation_shared_fnc_getMilitaryID.sqf
Author: Wyqer
...
if (_level == 0) then {
	...
	_return = format ["%1 %2", [(_level - 1)] call grad_liberation_shared_fnc_getMilitaryID, [(_count - (_level * (count military_alphabet)))] call grad_liberation_shared_fnc_getMilitaryID];
};
