...
_countblufor_ownership = [_thatpos, _localsize, GRLIB_side_friendly ] call grad_liberation_shared_fnc_getUnitsCount;
_countopfor_ownership = [_thatpos, _localsize, GRLIB_side_enemy ] call grad_liberation_shared_fnc_getUnitsCount;
