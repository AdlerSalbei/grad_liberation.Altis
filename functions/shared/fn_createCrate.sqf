/*
grad_liberation_shared_fnc_createCrate.sqf
Author: Wyqer
...
if !(_resource in KP_liberation_crates) exitWith {
	private _text = format ["[KP LIBERATION] [ERROR] grad_liberation_shared_fnc_createCrate.sqf -> invalid _resource: %1", _resource];
