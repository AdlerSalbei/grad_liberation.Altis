...
_red_forces = [ (markerpos _sector), _actual_capture_size, GRLIB_side_enemy ] call grad_liberation_shared_fnc_getUnitsCount;
_blue_forces = [ (markerpos _sector), _actual_capture_size, GRLIB_side_friendly ] call grad_liberation_shared_fnc_getUnitsCount;
_ratio = -1;
